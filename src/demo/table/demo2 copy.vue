              ...
              [
                h(
                  ...
                  this.reportList[params.index].list.map(item => {
                    return h("li", {}, item.time_period_name);
                  })
                )
              ]
            );
              ...
              return h(
                ...
                [
                  h(
                    "ul",
                    this.reportList[params.index].list.map(item => {
                      return h("li", {}, item.normal_amount);
                    })
                  )
                ]
              );
              ...
              return h(
                ...
                [
                  h(
                    "ul",
                    this.reportList[params.index].list.map(item => {
                      return h("li", {}, item.be_late_amount);
                    })
                  )
                ]
              );
              ...
              return h(
                ...
                [
                  h(
                    "ul",
                    this.reportList[params.index].list.map(item => {
                      return h("li", {}, item.leave_early_amount);
                    })
                  )
                ]
              );
              ...
              return h(
                ...
                [
                  h(
                    "ul",
                    this.reportList[params.index].list.map(item => {
                      return h("li", {}, item.not_attendance_amount);
                    })
                  )
                ]
              );
